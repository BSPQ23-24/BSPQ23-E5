...
public class BusesAdminPanel extends AdminPanel<BusDTO> {

    private JTextField licensePlateField;
    private JTextField modelField;
    private JTextField capacityField;

    public BusesAdminPanel(Color colorPrimary, Color colorSecondary, Color colorTertiary, Color colorBackground, ResourceBundle messages) {
