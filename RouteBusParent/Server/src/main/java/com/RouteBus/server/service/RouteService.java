...
public class RouteService {
    ...
    public List<Route> getRoutesByStations(String origin, String destination) {
        return routeRepository.findAll().stream()
            .filter(route -> route.getStartPoint().equalsIgnoreCase(origin) && route.getEndPoint().equalsIgnoreCase(destination))
